# Generated by Django 4.0.5 on 2022-07-01 02:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_range', models.IntegerField(choices=[(1, 'Low'), (2, 'Mid First'), (3, 'Mid Second'), (4, 'High')], null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('candidact', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='jobs.candidact')),
